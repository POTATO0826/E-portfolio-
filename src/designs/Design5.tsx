...
const hackathonProjects = [
  {
    ...
    name: 'ProjekWatch',
    icon: '⌚',
    desc: 'Cross-platform Flutter productivity app. Runs natively on Android, iOS, Web, and Desktop — all from a single codebase.',
  ...
  },
  {
    ...
    name: 'SkyClaw',
    icon: '🚁',
    desc: 'Drone surveillance system integrating computer vision, live web dashboard, and a Telegram bot for remote alerts — hosted on AWS VPS.',
